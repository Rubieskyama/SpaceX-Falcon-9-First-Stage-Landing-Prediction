...
def get_scatter_chart(entered_site, payload_range):
    ...
    filtered_df_payload = spacex_df[(spacex_df['Payload Mass (kg)'] >= low) & (spacex_df['Payload Mass (kg)'] <= high)]
    ...
    if entered_site == 'ALL':
        ...
        filtered_df_site_payload = filtered_df_payload[filtered_df_payload['Launch Site'] == entered_site]
        fig = px.scatter(
            filtered_df_site_payload,
            x='Payload Mass (kg)',
            y='class',
            color="Booster Version Category",
            title='Correlation between Payload and Success for all Sites'
